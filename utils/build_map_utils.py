...
from .baseline_utils import project_pixels_to_world_coords, apply_color_to_map, save_sem_map_through_plt, wrap_angle
from math import pi

cfg_SEM_MAP_CELL_SIZE = 0.05
cfg_SEM_MAP_IGNORED_SEM_CLASS = [0, 6]
cfg_SENSOR_AGENT_HEIGHT = 1.25  # 1.25
cfg_SEM_MAP_GRID_CLASS_SIZE = 1550
cfg_SEM_MAP_WORLD_SIZE = 20.0
...
class SemanticMap:
    ...
    def __init__(self, saved_folder):
        ...
        self.scene_name = ''
        self.cell_size = cfg_SEM_MAP_CELL_SIZE
        self.step_size = 100
        self.map_boundary = 5
        self.detector = None
        self.saved_folder = saved_folder

        self.IGNORED_CLASS = cfg_SEM_MAP_IGNORED_SEM_CLASS  # ceiling class is ignored

        # ==================================== initialize 4d grid =================================
        self.min_X = -cfg_SEM_MAP_WORLD_SIZE
        self.max_X = cfg_SEM_MAP_WORLD_SIZE
        self.min_Z = -cfg_SEM_MAP_WORLD_SIZE
        self.max_Z = cfg_SEM_MAP_WORLD_SIZE
        self.min_Y = 0.0
        self.max_Y = cfg_SENSOR_AGENT_HEIGHT + self.cell_size
        ...
        self.four_dim_grid = np.zeros(
            (len(self.z_grid), len(self.y_grid)+1,
             len(self.x_grid), cfg_SEM_MAP_GRID_CLASS_SIZE),
